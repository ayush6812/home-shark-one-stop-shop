        ...
        <ScrollAnimation>
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold mb-6 text-foreground">
              Why Choose <span className="text-amber-500">Home Shark</span>?
            </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {features.map((feature, index) => (
            <ScrollAnimation key={index} animation="fade-up" delay={index * 100}>
              <div className="text-center p-6 lg:p-8 rounded-2xl bg-white border border-slate-200 hover:border-amber-400/30 hover:shadow-xl hover:shadow-amber-500/10 transition-all duration-500 transform hover:-translate-y-2 cursor-default">
                <div className="w-14 h-14 bg-gradient-to-br from-amber-400 to-yellow-400 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg group-hover:scale-110 transition-transform">
